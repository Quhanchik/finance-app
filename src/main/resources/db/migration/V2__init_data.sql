insert into t_role(c_name) values('ROLE_USER'), ('ROLE_ADMIN');
insert into t_user(c_login, c_password) values('test', '$2a$12$6yjGgEg48XnpOr9itmzxIu1HtmqEhVFopu0bkjjnorwPp.0N2QvOe');
insert into t_user(c_login, c_password) values('admin', '$2a$12$6yjGgEg48XnpOr9itmzxIu1HtmqEhVFopu0bkjjnorwPp.0N2QvOe');
